...
OS_STK Task8Stk[TASK_STK_SIZE]; // Tarea añadida
OS_STK Task9Stk[TASK_STK_SIZE]; // Tarea añadida
OS_STK TaskStartStk[TASK_STK_SIZE];

/* Declaración de recursos */

OS_EVENT *uart0Sem;                /* Semáforo para el acceso mutex a la UART0 */
OS_EVENT *lcdSem;                  /* Semáforo para el acceso mutex al lcd */
...
void Task6( void *id );
void Task7( void *id );
void Task8( void *id ); // Tarea añadida
void Task9( void *id ); // Tarea añadida
...
void TaskStart( void *pdata )
{
    ...
    const char id6 = '6';
    const char id7 = '7';
    const char id8 = '8'; // Identificador añadido
    const char id9 = '9'; // Identificador añadido
...
void Task8(void *id){
    ...
    while(1)
    {
    	...
    	OSSemPend( lcdSem, 0, &err );
    		lcd_puts(15, 16, BLACK, "- La tecla 0x" );
